...
**J'ai le plaisir d'annoncer que je commencerai un nouveau poste de professeure adjointe à l'<a href="https://www.umontreal.ca/">Université de Montréal</a> en juin 2022, au sein du <a href="https://dms.umontreal.ca/fr/">Département de mathématiques et statistique</a>.**
...
**Avant mes études doctorales, j'ai travaillé pendant deux ans comme statisticien analyste à l'unité de pharmacoépidémiologie de McGill à l'Institut de recherche Lady Davis, Hôpital général juif, Montréal, CA, sous la supervision du <a href="http://www.ladydavis.ca/fr/samysuissa">Dr Samy Suissa</a>. J'y ai beaucoup travaillé avec des données d'observation (provenant par exemple de données de dossiers médicaux électroniques et de bases de données administratives) et j'ai beaucoup appris en effectuant des analyses de données complexes et en collaborant avec des experts de renommée mondiale en pharmacoépidémiologie. Par la suite, je me suis de plus en plus intéressé aux questions de recherche qui intéressent la communauté scientifique des épidémiologistes et des pharmacoépidémiologistes.**
